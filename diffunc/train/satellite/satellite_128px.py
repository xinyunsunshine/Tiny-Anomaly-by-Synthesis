...
parser = argparse.ArgumentParser(description='Train a DDPM on satellite imagery')
...
diffusion = GaussianDiffusion(
    model,
    image_size = (128, 128),    # size of image (height, width) originally this was (128, 128)
...
trainer = Trainer(
    diffusion,
    '/home/gridsan/groups/rrg/data/maryland_five_county_25k_256x256',
    train_batch_size = 32,  # was 32
    train_lr = 8e-5,  # was 8e-5
    train_num_steps = 50000,  # was 700000, # total training steps
    ...
    interpolation = 'nearest-exact',        # originally this was 'bilinear'
    convert_image_to = 'RGB',  # was unspecified, but is required since CLEVR is in RGBA format
    results_folder = '/home/gridsan/groups/rrg/results/satellite/maryland_128x128',
