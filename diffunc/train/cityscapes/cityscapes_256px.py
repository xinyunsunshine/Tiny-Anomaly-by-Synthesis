...
diffusion = GaussianDiffusion(
    model,
    image_size = (256, 512),    # size of image (height, width) originally this was (128, 128)
...
trainer = Trainer(
    ...
    train_batch_size = 6,  # was 32
    train_lr = 8e-5,
    train_num_steps = 100000,  # was 700000, # total training steps
    ...
    results_folder = 'results/cityscapes_256px',
